#1.Consulta todos los datos de las tablas EMPLE y DEPART.
SELECT * FROM emple;
SELECT * FROM depart;
...
#columna DEPT_NO.
SELECT dnombre,dept_no AS OI FROM depart;
...
SELECT nombre_alumno,(nota1+nota2+nota3)/3 AS notamedia FROM notas_alumnos
